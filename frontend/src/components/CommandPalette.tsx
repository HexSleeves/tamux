...
export function CommandPalette({ style, className }: CommandPaletteProps = {}) {
  ...
  const commands: Command[] = [
    ...
    { id: "verify-integrity", label: "Verify WORM Integrity", category: "Infrastructure", action: () => { (window as any).amux?.verifyIntegrity?.(); } },
    { id: "reload-cdui-views", label: "Reload CDUI Views", category: "Infrastructure", action: () => window.dispatchEvent(new Event("amux-cdui-views-reload")) },
